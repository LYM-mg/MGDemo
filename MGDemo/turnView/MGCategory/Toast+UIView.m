...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    ...
    FLLOG(@"Warning: Invalid position for toast.");
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        titleLabel.font = [UIFont boldSystemFontOfSize:CSToastFontSize * ScreenWidthRatio];
...
//        CGSize expectedSizeTitle = [title sizeWithFont:titleLabel.font constrainedToSize:maxSizeTitle lineBreakMode:titleLabel.lineBreakMode];
        CGSize expectedSizeTitle = [title boundingRectWithSize:maxSizeTitle options:NSStringDrawingUsesFontLeading | NSStringDrawingUsesLineFragmentOrigin attributes:dic context:nil].size;
    ...
    if (message != nil) {
        ...
        messageLabel.font = [UIFont systemFontOfSize:CSToastFontSize * ScreenWidthRatio];
        ...
        CGSize expectedSizeMessage = [message boundingRectWithSize:maxSizeMessage options:NSStringDrawingUsesFontLeading | NSStringDrawingUsesLineFragmentOrigin attributes:dic context:nil].size;
